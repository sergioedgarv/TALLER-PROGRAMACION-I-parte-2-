...
<style>
  /* Contenedor para el fondo entre header y footer */
  .content-wrapper {
    position: relative;
    min-height: calc(100vh - 120px); /* Ajustá según la altura combinada de header + footer */
    background-image: url('<?= base_url("img/ran1.jpg") ?>');
    background-size: cover;
    background-position: center;
    background-repeat: no-repeat;
    background-attachment: fixed; /* Para efecto fondo fijo */
    padding-top: 40px;
    padding-bottom: 40px;
  }
  ...
  <main class="container py-5">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        ...
        <form class="contact-form1" action="<?= base_url('contacto/enviar') ?>" method="POST" enctype="multipart/form-data">
          <!-- Nombre y Email -->
          <div class="row mb-3">
            <div class="col-md-6">
